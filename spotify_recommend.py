...
div.stButton > button:first-child {
    background-color: rgb(77, 182, 162);
}
                ...
                if i%2==0:
                    with col3:
                        ...
                        with st.expander("Data Visualisation🖼️"):
                            ...
                            polar_chart = px.line_polar (df, r='r', theta='characteristic', template = "seaborn", line_close=True,color_discrete_sequence=px.colors.sequential.greens)
